...
def test_emerges_keyboard_interrupt(sp_mocker: SubprocessMocker,
...
def test_emerges_live_rebuild(sp_mocker: SubprocessMocker,
                              mocker: MockFixture) -> None:
    sp_mocker.add_output4(
...
def test_emerges_daemon_reexec(sp_mocker: SubprocessMocker,
                               mocker: MockFixture) -> None:
    sys.argv = [
...
def test_emerges_daemon_reexec_no_systemd(sp_mocker: SubprocessMocker,
                                          mocker: MockFixture) -> None:
    sys.argv = [
        'emerges', '--no-live-rebuild', '--no-preserved-rebuild',
        '--no-upgrade-kernel'
